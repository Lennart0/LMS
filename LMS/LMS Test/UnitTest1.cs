...
namespace LMS_Test {
    ...
    public class UnitTest1 {
        ...
        public void CourseDaysTest() {
            ...
            Assert.IsTrue(4 == cd.NrCourseDaysDiff(new DateTime(2016, 3, 23), new DateTime(2016, 3, 31)));
            Assert.IsTrue(-4 == cd.NrCourseDaysDiff(new DateTime(2016, 3, 31), new DateTime(2016, 3, 23)));

            Assert.AreEqual(new DateTime(2016, 3, 24), cd.NthDayAfter(new DateTime(2016, 3, 31), -3));
            Assert.AreEqual(new DateTime(2016, 3, 31), cd.NthDayAfter(new DateTime(2016, 3, 24), 3));
        }
